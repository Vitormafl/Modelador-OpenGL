...
void Octree::addNodes(Node* parent) {
	...
	parent->childNodes[0]->nodeCenter = glm::vec3(parent->nodeCenter.x - centerDislocation,
	...
	parent->childNodes[1]->nodeCenter = glm::vec3(parent->nodeCenter.x - centerDislocation,
		parent->nodeCenter.y + centerDislocation,
		parent->nodeCenter.z - centerDislocation);
	...
	parent->childNodes[2]->nodeCenter = glm::vec3(parent->nodeCenter.x - centerDislocation,
		parent->nodeCenter.y - centerDislocation,
		parent->nodeCenter.z + centerDislocation);
	...
	parent->childNodes[3]->nodeCenter = glm::vec3(parent->nodeCenter.x - centerDislocation,
		parent->nodeCenter.y + centerDislocation,
		parent->nodeCenter.z + centerDislocation);
	...
	parent->childNodes[4]->nodeCenter = glm::vec3(parent->nodeCenter.x + centerDislocation,
		parent->nodeCenter.y - centerDislocation,
		parent->nodeCenter.z - centerDislocation);
	...
	parent->childNodes[5]->nodeCenter = glm::vec3(parent->nodeCenter.x + centerDislocation,
		parent->nodeCenter.y + centerDislocation,
		parent->nodeCenter.z - centerDislocation);
	...
	parent->childNodes[6]->nodeCenter = glm::vec3(parent->nodeCenter.x + centerDislocation,
		parent->nodeCenter.y - centerDislocation,
		parent->nodeCenter.z + centerDislocation);
	...
	parent->childNodes[7]->nodeCenter = glm::vec3(parent->nodeCenter.x + centerDislocation,
		parent->nodeCenter.y + centerDislocation,
		parent->nodeCenter.z + centerDislocation);
